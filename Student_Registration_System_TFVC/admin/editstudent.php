		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <select name="class" class="form-control" id="class" required="" value="">
		    	...
		    	<option value="1st" <?= $row['class']=='1st'? 'selected':'' ?>>Grade1</option>
		    	<option value="2nd" <?= $row['class']=='2nd'? 'selected':'' ?>>Grade2</option>
		    	<option value="3rd" <?= $row['class']=='3rd'? 'selected':'' ?>>Grade3</option>
		    	<option value="4th" <?= $row['class']=='4th'? 'selected':'' ?>>Grade4</option>
		    	<option value="5th" <?= $row['class']=='5th'? 'selected':'' ?>>Grade5</option>
					<option value="5th" <?= $row['class']=='6th'? 'selected':'' ?>>Grade6</option>
